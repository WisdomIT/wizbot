...
- Not yet possible: choosing the sound source (app/OBS), cafe gate integration settings, theme, account settings. Point the user to the menu, and to the manual page for cafe integration.
