...
const TOOL_LABEL: Record<string, string> = {
  ...
  blind_chat_message: '채팅 블라인드',
  list_restricted_viewers: '활동 제한 목록 조회',
  get_live_setting: '방송 설정 조회',
  update_live_setting: '방송 설정 변경',
  get_chat_settings: '채팅 설정 조회',
  update_chat_settings: '채팅 설정 변경',
  send_chat_notice: '채팅 공지 등록',
  get_channel_info: '채널 정보 조회',
  list_streaming_roles: '관리자 목록 조회',
  list_followers: '팔로워 조회',
  list_subscribers: '구독자 조회',
  web_search: '웹 검색',
